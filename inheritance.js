        ...
        case "1": // Adding Student
            {
                ...
                {
                    const student = new Student(urollno, uname, ugrade, usection);//calling Student class--//Student class is called--getting the variables and pushing it in student array in studentfunctions
                    studentDB.addStudent(student);//inheritance
                ...
                do {
                    ...
                    if (!isNaN(rollnoToEdit)) {
                        ...
                        if (studentToEdit) {
                            ...
                            studentDB.displayStudents(); //-->inheritance class is called
